...
const WhatsAppButton: React.FC = () => {
  const handleWhatsAppClick = () => {
    const phoneNumber = '919738371651';
    const message = 'Hello ETHICS Metal Forming Machineries! I am interested in your metal forming machines. Please share more information.';
